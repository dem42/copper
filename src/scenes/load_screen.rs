...
fn init_resourced_for_load_screen(resource_manager: &mut ResourceManager) {    
...
pub fn create_load_screen(resource_manager: &mut ResourceManager) -> LoadScreen {
    init_resourced_for_load_screen(resource_manager);
    ...
    let texts = vec![
        resource_manager.create_gui_text("Loading the world...", 
            ResourceManager::COPPER_SDF_FONT_TYPE, 4, Vector2f::new(0.0, 0.0), 
            TextMaterial {
